...
# если соответствующие регистрационные данные были переданы в приложение через переменные окружения.
# Если superuser зарегистрирован в базе данных или
# регистрационные данные не были переданы в переменные окружения - superuser не регистрируется.
